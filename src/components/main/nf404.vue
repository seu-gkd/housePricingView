<template>
  <section class="app-section" id="nf404">
    <div>
      <svg class="me404" viewBox="0 0 800 480">
	...
	c-11.4,0-20.6-9.2-20.6-20.6c0-11.4,9.2-20.6,20.6-20.6h21.2c11.4,0,20.6,9.2,20.6,20.6C353.3,177.9,344.1,187.1,332.8,187.1z"/>
		...
		C212.1,266.6,212.6,266.2,213.2,266.3z"/>
          <path id="nose_hole_1_" class="st10"
		...
		C207.1,267.3,207.6,266.9,208.1,266.9z"/>
          ...
          <path id="mongkey_shadow_1_" class="st0"
        ...
        <g id="number_4">
          <path id="number_4_outline" class="st1"
        ...
        <g id="number_4_2">
          <path id="number_4_outline_2" class="st1"
		...
		c6,0,10.5-4.5,10.5-10.1v-24.3h11.4C623.1,244.3,627,240.4,627,235.5z M586.5,226.4H541l45.5-67.8V226.4z"/>
          <path id="number_4_inner_lines_2" class="st14"
		...
		c-1.2,1.9-3.3,4.3-3.6,5.8c-0.8,4.6,2.3,5.5,7.3,5.5h51.5 M607,235h19.5 M589.5,232l-4,7 M592.5,232l-4,7 M605.5,232l-4,7
		 M608.5,232l-4,7"/>
          <path id="number_4_dots_2" class="st10"
        ...
        <g id="number_0">
          <path id="number_0_outline" class="st1"
		...
		C472.4,156.1,481.1,182.1,481.1,208.9z"/>
          <path id="number_0_inner_lines" class="st15"
		...
		C487,204.5,489.5,202,492.5,202z"/>
          <path id="number_0_dots" class="st10"
      ...
      <div style="margin-top:20px;text-align:center;line-height:30px;letter-spacing:.2em;">
        <span style="font-size:15px;color:#999;">网页地址不存在哎～</span><br>
